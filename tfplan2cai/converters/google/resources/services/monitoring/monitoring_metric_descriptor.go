...
func ResourceConverterMonitoringMetricDescriptor() tpgresource.ResourceConverter {
...
func GetMonitoringMetricDescriptorCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
