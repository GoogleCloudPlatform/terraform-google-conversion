...
func init() {
	registry.Schema{
		Name:        "google_scc_v2_project_notification_config",
		ProductName: "securitycenterv2",
		Type:        registry.SchemaTypeResource,
		Schema:      ResourceSecurityCenterV2ProjectNotificationConfig(),
	}.Register()
}

const SecurityCenterV2ProjectNotificationConfigSchemaName string = "google_scc_v2_project_notification_config"
