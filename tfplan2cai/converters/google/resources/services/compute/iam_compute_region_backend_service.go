...
// NewComputeRegionBackendServiceIamMemberResource returns the google_compute_region_backend_service_iam_member
// managed resource. It is shared by the managed resource registration and the
// list resource, so both stay in sync.
func NewComputeRegionBackendServiceIamMemberResource() *schema.Resource {
	return tpgiamresource.ResourceIamMember(
		ComputeRegionBackendServiceIamSchema,
		ComputeRegionBackendServiceIamUpdaterProducer,
		ComputeRegionBackendServiceIdParseFunc,
		tpgiamresource.IamWithParentResourceIdentity(ComputeRegionBackendServiceIamParentParentResourceIdentityParser),
	)
}
...
func ComputeRegionBackendServiceIamParentParentResourceIdentityParser(d *schema.ResourceData, identity *schema.IdentityData, transportConfig *transport_tpg.Config) (string, error) {
	return tpgiamresource.ParseIamResourceIdentity(d, identity, transportConfig, tpgiamresource.IamResourceIdentityConfig{
		...
		UriFormat: "projects/%s/regions/%s/backendServices/%s",
	})
}
