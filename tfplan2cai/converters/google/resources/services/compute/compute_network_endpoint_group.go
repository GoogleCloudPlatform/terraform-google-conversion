...
func ResourceConverterComputeNetworkEndpointGroup() tpgresource.ResourceConverter {
...
func GetComputeNetworkEndpointGroupCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//compute.googleapis.com/projects/{{project}}/zones/{{zone}}/networkEndpointGroups/{{name}}")
	if err != nil {
