...
func ResourceConverterNetworkServicesEdgeCacheService() tpgresource.ResourceConverter {
...
func GetNetworkServicesEdgeCacheServiceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//networkservices.googleapis.com/projects/{{project}}/locations/global/edgeCacheServices/{{name}}")
	if err != nil {
