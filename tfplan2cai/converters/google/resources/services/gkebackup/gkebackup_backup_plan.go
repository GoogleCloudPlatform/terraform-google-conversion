...
func ResourceConverterGKEBackupBackupPlan() tpgresource.ResourceConverter {
...
func GetGKEBackupBackupPlanCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
