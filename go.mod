...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20231027154156-abf785b0c83a
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.54.0 // indirect
