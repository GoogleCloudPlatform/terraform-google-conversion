...
func ResourceConverterAccessApprovalProjectSettings() tpgresource.ResourceConverter {
...
func GetAccessApprovalProjectSettingsCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//accessapproval.googleapis.com/projects/{{project_id}}/accessApprovalSettings")
	if err != nil {
