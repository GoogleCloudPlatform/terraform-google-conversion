...
func ApphubApplicationTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetApphubApplicationCaiAssets,
	}
}

func GetApphubApplicationCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	...
	if obj, err := GetApphubApplicationCaiObject(d, config); err == nil {
...
func GetApphubApplicationCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
