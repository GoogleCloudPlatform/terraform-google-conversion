...
func newVertexAIEndpointIamAsset(
	...
	name, err := cai.AssetName(d, config, "//{{region}}-aiplatform.googleapis.com/projects/{{project}}/locations/{{location}}/endpoints/{{endpoint}}")
	if err != nil {
...
func FetchVertexAIEndpointIamPolicy(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (cai.Asset, error) {
	...
	return cai.FetchIamPolicy(
		...
		d,
		config,
		"//{{region}}-aiplatform.googleapis.com/projects/{{project}}/locations/{{location}}/endpoints/{{endpoint}}",
