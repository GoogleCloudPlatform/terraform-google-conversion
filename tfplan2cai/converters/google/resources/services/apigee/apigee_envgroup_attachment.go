...
func ResourceConverterApigeeEnvgroupAttachment() tpgresource.ResourceConverter {
...
func GetApigeeEnvgroupAttachmentCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigee.googleapis.com/{{envgroup_id}}/attachments/{{name}}")
	if err != nil {
