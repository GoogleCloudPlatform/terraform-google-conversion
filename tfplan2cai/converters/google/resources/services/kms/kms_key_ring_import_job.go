...
func ResourceConverterKMSKeyRingImportJob() tpgresource.ResourceConverter {
...
func GetKMSKeyRingImportJobCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
