...
func ResourceConverterCertificateManagerDnsAuthorization() tpgresource.ResourceConverter {
...
func GetCertificateManagerDnsAuthorizationCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//certificatemanager.googleapis.com/projects/{{project}}/locations/global/dnsAuthorizations/{{name}}")
	if err != nil {
