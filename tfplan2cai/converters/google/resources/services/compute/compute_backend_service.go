...
func ResourceConverterComputeBackendService() tpgresource.ResourceConverter {
...
func GetComputeBackendServiceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
