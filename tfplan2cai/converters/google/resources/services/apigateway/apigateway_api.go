...
func ResourceConverterApiGatewayApi() tpgresource.ResourceConverter {
...
func GetApiGatewayApiCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigateway.googleapis.com/projects/{{project}}/locations/global/apis/{{api_id}}")
	if err != nil {
