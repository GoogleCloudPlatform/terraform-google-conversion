...
func ResourceConverterComputeUrlMap() tpgresource.ResourceConverter {
...
func GetComputeUrlMapCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//compute.googleapis.com/projects/{{project}}/global/urlMaps/{{name}}")
	if err != nil {
