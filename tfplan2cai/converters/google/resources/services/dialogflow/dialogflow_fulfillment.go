...
func ResourceConverterDialogflowFulfillment() tpgresource.ResourceConverter {
...
func GetDialogflowFulfillmentCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
