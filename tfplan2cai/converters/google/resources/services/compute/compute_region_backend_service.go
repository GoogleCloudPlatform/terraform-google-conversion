...
func ResourceConverterComputeRegionBackendService() tpgresource.ResourceConverter {
...
func GetComputeRegionBackendServiceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
