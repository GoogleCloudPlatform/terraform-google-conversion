...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20231205022608-9712e1e3d437
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.57.0 // indirect
