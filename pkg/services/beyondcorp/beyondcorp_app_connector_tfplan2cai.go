...
func BeyondcorpAppConnectorTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetBeyondcorpAppConnectorCaiAssets,
	}
}

func GetBeyondcorpAppConnectorCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	name, err := cai.AssetName(d, config, "//beyondcorp.googleapis.com/projects/{{project}}/locations/{{region}}/appConnectors/{{name}}")
	if err != nil {
		return []caiasset.Asset{}, err
	}
	if obj, err := GetBeyondcorpAppConnectorCaiObject(d, config); err == nil {
...
func GetBeyondcorpAppConnectorCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
