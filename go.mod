...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20240125155636-c1d6b58da9b5
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.61.0 // indirect
