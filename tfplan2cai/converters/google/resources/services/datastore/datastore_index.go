...
func ResourceConverterDatastoreIndex() tpgresource.ResourceConverter {
...
func GetDatastoreIndexCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//datastore.googleapis.com/projects/{{project}}/indexes/{{index_id}}")
	if err != nil {
