...
import (
	...
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/cloudfunctions"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/cloudfunctions2"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/cloudrun"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/cloudrunv2"
	...
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/datafusion"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/dataplex"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/dataproc"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/dataprocmetastore"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/datastream"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/dns"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/filestore"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/firebase"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/gemini"
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/tfplan2cai/converters/google/resources/services/gkebackup"
...
func ResourceConverters() map[string][]cai.ResourceConverter {
	return map[string][]cai.ResourceConverter{
		...
		"google_kms_crypto_key_version":                                 {kms.ResourceConverterKMSCryptoKeyVersion()},
		...
		"google_compute_instant_snapshot_iam_policy":                    {compute.ResourceConverterComputeInstantSnapshotIamPolicy()},
		"google_compute_instant_snapshot_iam_binding":                   {compute.ResourceConverterComputeInstantSnapshotIamBinding()},
		...
		"google_compute_storage_pool_iam_policy":                        {compute.ResourceConverterComputeStoragePoolIamPolicy()},
		"google_compute_storage_pool_iam_binding":                       {compute.ResourceConverterComputeStoragePoolIamBinding()},
		"google_compute_storage_pool_iam_member":                        {compute.ResourceConverterComputeStoragePoolIamMember()},
		...
		"google_dataproc_metastore_database_iam_policy":                 {dataprocmetastore.ResourceConverterDataprocMetastoreDatabaseIamPolicy()},
		"google_dataproc_metastore_database_iam_binding":                {dataprocmetastore.ResourceConverterDataprocMetastoreDatabaseIamBinding()},
		"google_dataproc_metastore_database_iam_member":                 {dataprocmetastore.ResourceConverterDataprocMetastoreDatabaseIamMember()},
		...
		"google_dataproc_metastore_table_iam_policy":                    {dataprocmetastore.ResourceConverterDataprocMetastoreTableIamPolicy()},
		"google_dataproc_metastore_table_iam_binding":                   {dataprocmetastore.ResourceConverterDataprocMetastoreTableIamBinding()},
		"google_dataproc_metastore_table_iam_member":                    {dataprocmetastore.ResourceConverterDataprocMetastoreTableIamMember()},
		...
		"google_vertex_ai_feature_group_iam_policy":                     {vertexai.ResourceConverterVertexAIFeatureGroupIamPolicy()},
		"google_vertex_ai_feature_group_iam_binding":                    {vertexai.ResourceConverterVertexAIFeatureGroupIamBinding()},
		"google_vertex_ai_feature_group_iam_member":                     {vertexai.ResourceConverterVertexAIFeatureGroupIamMember()},
		"google_vertex_ai_feature_online_store_iam_policy":              {vertexai.ResourceConverterVertexAIFeatureOnlineStoreIamPolicy()},
		"google_vertex_ai_feature_online_store_iam_binding":             {vertexai.ResourceConverterVertexAIFeatureOnlineStoreIamBinding()},
		"google_vertex_ai_feature_online_store_iam_member":              {vertexai.ResourceConverterVertexAIFeatureOnlineStoreIamMember()},
		"google_vertex_ai_feature_online_store_featureview_iam_policy":  {vertexai.ResourceConverterVertexAIFeatureOnlineStoreFeatureviewIamPolicy()},
		...
		"google_vertex_ai_feature_online_store_featureview_iam_member":  {vertexai.ResourceConverterVertexAIFeatureOnlineStoreFeatureviewIamMember()},
