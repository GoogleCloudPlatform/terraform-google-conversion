...
func ResourceConverterVPCAccessConnector() tpgresource.ResourceConverter {
...
func GetVPCAccessConnectorCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//vpcaccess.googleapis.com/projects/{{project}}/locations/{{region}}/connectors/{{name}}")
	if err != nil {
