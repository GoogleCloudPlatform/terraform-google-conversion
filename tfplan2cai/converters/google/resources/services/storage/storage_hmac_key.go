...
func ResourceConverterStorageHmacKey() tpgresource.ResourceConverter {
...
func GetStorageHmacKeyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//storage.googleapis.com/projects/{{project}}/hmacKeys/{{access_id}}")
	if err != nil {
