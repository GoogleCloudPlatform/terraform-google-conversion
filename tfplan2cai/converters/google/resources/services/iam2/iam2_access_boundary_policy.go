...
func ResourceConverterIAM2AccessBoundaryPolicy() tpgresource.ResourceConverter {
...
func GetIAM2AccessBoundaryPolicyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//iam.googleapis.com/policies/{{parent}}/accessboundarypolicies/{{name}}")
	if err != nil {
