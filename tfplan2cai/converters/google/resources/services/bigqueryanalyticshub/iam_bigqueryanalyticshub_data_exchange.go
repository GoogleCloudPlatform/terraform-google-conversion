...
func BigqueryAnalyticsHubDataExchangeIamUpdaterProducer(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (tpgiamresource.ResourceIamUpdater, error) {
	...
	m, err := tpgresource.GetImportIdQualifiers([]string{"projects/(?P<project>[^/]+)/locations/(?P<location>[^/]+)/dataExchanges/(?P<data_exchange_id>[^/]+)", "(?P<project>[^/]+)/(?P<location>[^/]+)/(?P<data_exchange_id>[^/]+)", "(?P<location>[^/]+)/(?P<data_exchange_id>[^/]+)", "(?P<data_exchange_id>[^/]+)"}, d, config, d.Get("data_exchange_id").(string))
	if err != nil {
		return nil, err
	}
...
func BigqueryAnalyticsHubDataExchangeIdParseFunc(d *schema.ResourceData, config *transport_tpg.Config) error {
	values := make(map[string]string)
	...
	m, err := tpgresource.GetImportIdQualifiers([]string{"projects/(?P<project>[^/]+)/locations/(?P<location>[^/]+)/dataExchanges/(?P<data_exchange_id>[^/]+)", "(?P<project>[^/]+)/(?P<location>[^/]+)/(?P<data_exchange_id>[^/]+)", "(?P<location>[^/]+)/(?P<data_exchange_id>[^/]+)", "(?P<data_exchange_id>[^/]+)"}, d, config, d.Id())
	if err != nil {
		return err
	}
...
func BigqueryAnalyticsHubDataExchangeIamParentParentResourceIdentityParser(d *schema.ResourceData, identity *schema.IdentityData, transportConfig *transport_tpg.Config) (string, error) {
	return tpgiamresource.ParseIamResourceIdentity(d, identity, transportConfig, tpgiamresource.IamResourceIdentityConfig{
		...
		UriFormat: "projects/%s/locations/%s/dataExchanges/%s",
	})
}
