...
func ResourceConverterMemcacheInstance() tpgresource.ResourceConverter {
...
func GetMemcacheInstanceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//memcache.googleapis.com/projects/{{project}}/locations/{{region}}/instances/{{name}}")
	if err != nil {
