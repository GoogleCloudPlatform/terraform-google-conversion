...
func ResourceConverterNetworkServicesEdgeCacheKeyset() tpgresource.ResourceConverter {
...
func GetNetworkServicesEdgeCacheKeysetCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//networkservices.googleapis.com/projects/{{project}}/locations/global/edgeCacheKeysets/{{name}}")
	if err != nil {
