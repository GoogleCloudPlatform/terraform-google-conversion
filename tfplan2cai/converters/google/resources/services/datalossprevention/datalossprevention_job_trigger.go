...
func ResourceConverterDataLossPreventionJobTrigger() tpgresource.ResourceConverter {
...
func GetDataLossPreventionJobTriggerCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//dlp.googleapis.com/{{parent}}/jobTriggers/{{name}}")
	if err != nil {
