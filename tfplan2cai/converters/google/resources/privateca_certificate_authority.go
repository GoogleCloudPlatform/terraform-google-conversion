...
func isNewResource(diff tpgresource.TerraformResourceDiff) bool {
	name := diff.Get("name")
	return name.(string) == ""
}
...
func GetPrivatecaCertificateAuthorityCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
