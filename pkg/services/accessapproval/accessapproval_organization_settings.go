...
func init() {
	registry.Schema{
		...
		Schema:      ResourceAccessApprovalOrganizationSettings(),
	}.Register()
}

const AccessApprovalOrganizationSettingsSchemaName string = "google_organization_access_approval_settings"
