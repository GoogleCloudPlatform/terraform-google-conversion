...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20250514230958-d43e48715564
...
require (
	...
	github.com/hashicorp/terraform-plugin-go v0.27.0-alpha.1 // indirect
