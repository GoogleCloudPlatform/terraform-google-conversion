...
func GetComputeSnapshotIamPolicyCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newComputeSnapshotIamAsset(d, config, expandIamPolicyBindings)
}

func GetComputeSnapshotIamBindingCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newComputeSnapshotIamAsset(d, config, expandIamRoleBindings)
}

func GetComputeSnapshotIamMemberCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
...
func FetchComputeSnapshotIamPolicy(d TerraformResourceData, config *transport_tpg.Config) (Asset, error) {
