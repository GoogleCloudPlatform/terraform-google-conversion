...
func ResourceConverterPrivatecaCaPool() tpgresource.ResourceConverter {
...
func GetPrivatecaCaPoolCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//privateca.googleapis.com/projects/{{project}}/locations/{{location}}/caPools/{{name}}")
	if err != nil {
