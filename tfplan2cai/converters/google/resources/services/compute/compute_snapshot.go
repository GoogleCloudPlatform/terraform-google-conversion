...
func ResourceConverterComputeSnapshot() tpgresource.ResourceConverter {
...
func GetComputeSnapshotCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
