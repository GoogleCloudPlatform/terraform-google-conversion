...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20231107174009-c2933ea0e4ff
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.55.0 // indirect
