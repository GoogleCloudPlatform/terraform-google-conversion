...
func ResourceConverterCloudIdentityGroup() tpgresource.ResourceConverter {
...
func GetCloudIdentityGroupCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
