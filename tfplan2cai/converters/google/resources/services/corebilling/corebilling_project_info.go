...
func ResourceConverterCoreBillingProjectInfo() tpgresource.ResourceConverter {
...
func GetCoreBillingProjectInfoCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//cloudbilling.googleapis.com/projects/{{project}}/billingInfo/{{name}}")
	if err != nil {
