...
func ResourceConverterDocumentAIWarehouseLocation() tpgresource.ResourceConverter {
...
func GetDocumentAIWarehouseLocationCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//contentwarehouse.googleapis.com/projects/{{project_number}}/locations/{{location}}:initialize/{{name}}")
	if err != nil {
