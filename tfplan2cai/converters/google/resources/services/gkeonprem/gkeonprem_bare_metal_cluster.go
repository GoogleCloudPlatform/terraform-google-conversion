...
func ResourceConverterGkeonpremBareMetalCluster() tpgresource.ResourceConverter {
...
func GetGkeonpremBareMetalClusterCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//gkeonprem.googleapis.com/projects/{{project}}/locations/{{location}}/bareMetalClusters/{{name}}")
	if err != nil {
