...
func ResourceConverterCloudAssetFolderFeed() tpgresource.ResourceConverter {
...
func GetCloudAssetFolderFeedCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
