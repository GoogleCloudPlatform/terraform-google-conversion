...
func ResourceConverterCloudRunV2Service() tpgresource.ResourceConverter {
...
func GetCloudRunV2ServiceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
