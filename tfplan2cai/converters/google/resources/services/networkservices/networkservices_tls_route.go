...
func ResourceConverterNetworkServicesTlsRoute() tpgresource.ResourceConverter {
...
func GetNetworkServicesTlsRouteCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//networkservices.googleapis.com/projects/{{project}}/locations/global/tlsRoutes/{{name}}")
	if err != nil {
