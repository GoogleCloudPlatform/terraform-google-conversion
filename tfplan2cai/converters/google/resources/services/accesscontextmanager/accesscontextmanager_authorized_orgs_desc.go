...
func ResourceConverterAccessContextManagerAuthorizedOrgsDesc() tpgresource.ResourceConverter {
...
func GetAccessContextManagerAuthorizedOrgsDescCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
