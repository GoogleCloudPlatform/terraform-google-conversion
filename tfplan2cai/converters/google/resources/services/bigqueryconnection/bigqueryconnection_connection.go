...
func ResourceConverterBigqueryConnectionConnection() tpgresource.ResourceConverter {
...
func GetBigqueryConnectionConnectionCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
