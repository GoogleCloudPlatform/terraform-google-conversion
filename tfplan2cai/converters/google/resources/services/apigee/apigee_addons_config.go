...
func ResourceConverterApigeeAddonsConfig() tpgresource.ResourceConverter {
...
func GetApigeeAddonsConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigee.googleapis.com/organizations/{{org}}")
	if err != nil {
