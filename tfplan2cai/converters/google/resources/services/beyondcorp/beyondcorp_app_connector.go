...
func ResourceConverterBeyondcorpAppConnector() tpgresource.ResourceConverter {
...
func GetBeyondcorpAppConnectorCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//beyondcorp.googleapis.com/projects/{{project}}/locations/{{region}}/appConnectors/{{name}}")
	if err != nil {
