...
func init() {
	registry.Schema{
		Name:        "google_workbench_instance",
		ProductName: "workbench",
		Type:        registry.SchemaTypeResource,
		Schema:      ResourceWorkbenchInstance(),
	}.Register()
}
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"type": {
										Type:         schema.TypeString,
										Optional:     true,
										ValidateFunc: verify.ValidateEnum([]string{"NVIDIA_TESLA_P100", "NVIDIA_TESLA_V100", "NVIDIA_TESLA_P4", "NVIDIA_TESLA_T4", "NVIDIA_TESLA_A100", "NVIDIA_A100_80GB", "NVIDIA_L4", "NVIDIA_H100_80GB", "NVIDIA_H100_MEGA_80GB", "NVIDIA_H200_141GB", "NVIDIA_B200", "NVIDIA_RTX6000", "NVIDIA_TESLA_T4_VWS", "NVIDIA_TESLA_P100_VWS", "NVIDIA_TESLA_P4_VWS", ""}),
