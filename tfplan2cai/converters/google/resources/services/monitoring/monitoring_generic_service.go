...
func ResourceConverterMonitoringGenericService() tpgresource.ResourceConverter {
...
func GetMonitoringGenericServiceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//monitoring.googleapis.com/projects/{{project}}/services/{{service_id}}")
	if err != nil {
