...
func ResourceConverterDNSPolicy() tpgresource.ResourceConverter {
...
func GetDNSPolicyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//dns.googleapis.com/projects/{{project}}/policies/{{name}}")
	if err != nil {
