...
func GetBigqueryAnalyticsHubListingIamPolicyCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newBigqueryAnalyticsHubListingIamAsset(d, config, expandIamPolicyBindings)
}

func GetBigqueryAnalyticsHubListingIamBindingCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newBigqueryAnalyticsHubListingIamAsset(d, config, expandIamRoleBindings)
}

func GetBigqueryAnalyticsHubListingIamMemberCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
...
func FetchBigqueryAnalyticsHubListingIamPolicy(d TerraformResourceData, config *transport_tpg.Config) (Asset, error) {
