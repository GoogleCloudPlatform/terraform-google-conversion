...
func ResourceConverterBigqueryAnalyticsHubListing() tpgresource.ResourceConverter {
...
func GetBigqueryAnalyticsHubListingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
