...
func TestAccEventarcGoogleChannelConfig(t *testing.T) {
	...
	tests := []test.TestCase{
		{
			Name: "TestAccEventarcGoogleChannelConfig/basic",
		},
		{
			Name: "TestAccEventarcGoogleChannelConfig/cryptoKeyUpdate",
		},
		{
			Name: "TestAccEventarcGoogleChannelConfig/longForm",
		},
		{
			Name: "TestAccEventarcGoogleChannelConfig",
		},
	}
