...
func GetDataprocAutoscalingPolicyIamPolicyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newDataprocAutoscalingPolicyIamAsset(d, config, expandIamPolicyBindings)
}

func GetDataprocAutoscalingPolicyIamBindingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newDataprocAutoscalingPolicyIamAsset(d, config, expandIamRoleBindings)
}

func GetDataprocAutoscalingPolicyIamMemberCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
...
func FetchDataprocAutoscalingPolicyIamPolicy(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (Asset, error) {
