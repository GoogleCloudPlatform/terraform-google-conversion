...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20250505173505-9655a44dc5dc
...
require (
	...
	github.com/hashicorp/terraform-plugin-go v0.27.0-alpha.1.0.20250325210248-fa8d1fe4306b // indirect
