...
func ResourceConverterDialogflowCXEntityType() tpgresource.ResourceConverter {
...
func GetDialogflowCXEntityTypeCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//{{location}}-dialogflow.googleapis.com/{{parent}}/entityTypes/{{name}}")
	if err != nil {
