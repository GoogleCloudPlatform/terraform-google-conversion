...
func ResourceConverterAppEngineDomainMapping() tpgresource.ResourceConverter {
...
func GetAppEngineDomainMappingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//appengine.googleapis.com/apps/{{project}}/domainMappings/{{domain_name}}")
	if err != nil {
