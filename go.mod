...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20260227191434-1e499bc5fac3
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.84.0 // indirect
