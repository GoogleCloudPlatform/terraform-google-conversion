...
func SecretManagerRegionalRegionalSecretTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetSecretManagerRegionalRegionalSecretCaiAssets,
	}
}

func GetSecretManagerRegionalRegionalSecretCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	name, err := cai.AssetName(d, config, "//secretmanager.googleapis.com/projects/{{project}}/locations/{{location}}/secrets/{{secret_id}}")
	if err != nil {
		return []caiasset.Asset{}, err
	}
	if obj, err := GetSecretManagerRegionalRegionalSecretCaiObject(d, config); err == nil {
		...
		return []caiasset.Asset{
			{
				Name: name,
				Type: SecretManagerRegionalSecretAssetType,
...
func GetSecretManagerRegionalRegionalSecretCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	effectiveAnnotationsProp, err := expandSecretManagerRegionalRegionalSecretEffectiveAnnotations(d.Get("effective_annotations"), d, config)
	if err != nil {
		return nil, err
