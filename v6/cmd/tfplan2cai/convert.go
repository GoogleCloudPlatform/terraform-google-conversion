...
const convertDesc = `
This command will convert a Terraform plan json file into CAI (Cloud Asset Inventory)
assets and output them as a JSON array.
...
func newConvertCmd(rootOptions *model.RootOptions) *cobra.Command {
	o := &convertOptions{
