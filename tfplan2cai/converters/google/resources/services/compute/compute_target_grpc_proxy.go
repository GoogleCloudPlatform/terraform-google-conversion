...
func ResourceConverterComputeTargetGrpcProxy() tpgresource.ResourceConverter {
...
func GetComputeTargetGrpcProxyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//compute.googleapis.com/projects/{{project}}/global/targetGrpcProxies/{{name}}")
	if err != nil {
