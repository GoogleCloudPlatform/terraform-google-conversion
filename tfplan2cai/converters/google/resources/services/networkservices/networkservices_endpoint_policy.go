...
func ResourceConverterNetworkServicesEndpointPolicy() tpgresource.ResourceConverter {
...
func GetNetworkServicesEndpointPolicyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//networkservices.googleapis.com/projects/{{project}}/locations/global/endpointPolicies/{{name}}")
	if err != nil {
