...
func ResourceConverterDocumentAIProcessor() tpgresource.ResourceConverter {
...
func GetDocumentAIProcessorCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//{{location}}-documentai.googleapis.com/projects/{{project}}/locations/{{location}}/processors/{{name}}")
	if err != nil {
