...
func ResourceConverterApigeeEnvReferences() tpgresource.ResourceConverter {
...
func GetApigeeEnvReferencesCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigee.googleapis.com/{{env_id}}/references/{{name}}")
	if err != nil {
