...
func ResourceConverterGameServicesGameServerDeploymentRollout() tpgresource.ResourceConverter {
...
func GetGameServicesGameServerDeploymentRolloutCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//gameservices.googleapis.com/projects/{{project}}/locations/global/gameServerDeployments/{{deployment_id}}/rollout")
	if err != nil {
