...
func ResourceConverterIdentityPlatformTenantDefaultSupportedIdpConfig() tpgresource.ResourceConverter {
...
func GetIdentityPlatformTenantDefaultSupportedIdpConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//identitytoolkit.googleapis.com/projects/{{project}}/tenants/{{tenant}}/defaultSupportedIdpConfigs/{{idp_id}}")
	if err != nil {
