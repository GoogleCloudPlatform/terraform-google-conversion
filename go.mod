...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.11.0 // indirect
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20220627193729-8a4cc7b8ccb0 // indirect
