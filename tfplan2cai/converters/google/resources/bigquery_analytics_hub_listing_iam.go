...
func GetBigqueryAnalyticsHubListingIamPolicyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newBigqueryAnalyticsHubListingIamAsset(d, config, expandIamPolicyBindings)
}

func GetBigqueryAnalyticsHubListingIamBindingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newBigqueryAnalyticsHubListingIamAsset(d, config, expandIamRoleBindings)
}

func GetBigqueryAnalyticsHubListingIamMemberCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
...
func FetchBigqueryAnalyticsHubListingIamPolicy(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (Asset, error) {
