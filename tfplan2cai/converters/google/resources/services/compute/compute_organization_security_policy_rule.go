...
func ResourceConverterComputeOrganizationSecurityPolicyRule() tpgresource.ResourceConverter {
...
func GetComputeOrganizationSecurityPolicyRuleCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//compute.googleapis.com/{{policy_id}}/getRule?priority={{priority}}")
	if err != nil {
