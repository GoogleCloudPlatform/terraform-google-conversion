...
func init() {
	registry.Schema{
		Name:        "google_scc_v2_organization_scc_big_query_exports",
		ProductName: "securitycenterv2",
		Type:        registry.SchemaTypeResource,
		Schema:      ResourceSecurityCenterV2OrganizationSccBigQueryExports(),
	}.Register()
}

const SecurityCenterV2OrganizationSccBigQueryExportsSchemaName string = "google_scc_v2_organization_scc_big_query_exports"
