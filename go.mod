...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20240605154943-8a69bad4c2f0
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.67.0 // indirect
