...
func ResourceConverterCertificateManagerCertificateMap() tpgresource.ResourceConverter {
...
func GetCertificateManagerCertificateMapCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//certificatemanager.googleapis.com/projects/{{project}}/locations/global/certificateMaps/{{name}}")
	if err != nil {
