				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"cache_policy": {
							Type:     schema.TypeList,
							Optional: true,
							Description: `Specifies the cache policy configuration for matched traffic. Available
...
values.`,
										...
										AtLeastOneOf: []string{"default_route_action.0.cache_policy.0.cache_bypass_request_header_names", "default_route_action.0.cache_policy.0.cache_key_policy", "default_route_action.0.cache_policy.0.cache_mode", "default_route_action.0.cache_policy.0.client_ttl", "default_route_action.0.cache_policy.0.default_ttl", "default_route_action.0.cache_policy.0.max_ttl", "default_route_action.0.cache_policy.0.negative_caching", "default_route_action.0.cache_policy.0.negative_caching_policy", "default_route_action.0.cache_policy.0.request_coalescing", "default_route_action.0.cache_policy.0.serve_while_stale"},
									},
									"cache_key_policy": {
										Type:     schema.TypeList,
										Optional: true,
										Description: `The cache key configuration. If not specified, the default behavior depends
...
the cache key.`,
													...
													ConflictsWith: []string{"default_route_action.0.cache_policy.0.cache_key_policy.0.included_query_parameters"},
													AtLeastOneOf:  []string{"default_route_action.0.cache_policy.0.cache_key_policy.0.excluded_query_parameters", "default_route_action.0.cache_policy.0.cache_key_policy.0.include_host", "default_route_action.0.cache_policy.0.cache_key_policy.0.include_protocol", "default_route_action.0.cache_policy.0.cache_key_policy.0.include_query_string", "default_route_action.0.cache_policy.0.cache_key_policy.0.included_cookie_names", "default_route_action.0.cache_policy.0.cache_key_policy.0.included_header_names", "default_route_action.0.cache_policy.0.cache_key_policy.0.included_query_parameters"},
												},
												"include_host": {
													Type:     schema.TypeBool,
													Optional: true,
													Description: `If true, requests to different hosts will be cached separately. Note:
...
configuration error.`,
												...
												"include_protocol": {
													Type:     schema.TypeBool,
													Optional: true,
													Description: `If true, http and https requests will be cached separately. Note: This
...
the cache key.`,
												...
												"included_cookie_names": {
													Type:     schema.TypeList,
													Optional: true,
													Description: `Allows HTTP cookies (by name) to be used in the cache key. The
...
encoded and not treated as delimiters.`,
													...
													ConflictsWith: []string{"default_route_action.0.cache_policy.0.cache_key_policy.0.excluded_query_parameters"},
													AtLeastOneOf:  []string{"default_route_action.0.cache_policy.0.cache_key_policy.0.excluded_query_parameters", "default_route_action.0.cache_policy.0.cache_key_policy.0.include_host", "default_route_action.0.cache_policy.0.cache_key_policy.0.include_protocol", "default_route_action.0.cache_policy.0.cache_key_policy.0.include_query_string", "default_route_action.0.cache_policy.0.cache_key_policy.0.included_cookie_names", "default_route_action.0.cache_policy.0.cache_key_policy.0.included_header_names", "default_route_action.0.cache_policy.0.cache_key_policy.0.included_query_parameters"},
												},
											},
										},
									...
									"cache_mode": {
										...
										Description: `Specifies the cache setting for all responses from this route. If not
specified, Cloud CDN uses CACHE_ALL_STATIC mode. Possible values: ["USE_ORIGIN_HEADERS", "FORCE_CACHE_ALL", "CACHE_ALL_STATIC"]`,
									...
									"client_ttl": {
										Type:     schema.TypeList,
										Optional: true,
										Description: `Specifies a separate client (e.g. browser client) maximum TTL for cached
...
Cannot be specified when cacheMode is USE_ORIGIN_HEADERS.`,
									...
									"default_ttl": {
										Type:     schema.TypeList,
										Optional: true,
										Description: `Specifies the default TTL for cached content for responses that do not have
...
USE_ORIGIN_HEADERS.`,
									...
									"max_ttl": {
										Type:     schema.TypeList,
										Optional: true,
										Description: `Specifies the maximum allowed TTL for cached content. Cache directives that
...
mode.`,
									...
									"negative_caching": {
										Type:     schema.TypeBool,
										Optional: true,
										Description: `Negative caching allows per-status code TTLs to be set, in order to apply
...
specified, Cloud CDN applies negative caching by default.`,
									...
									"negative_caching_policy": {
										Type:     schema.TypeList,
										Optional: true,
										Description: `Sets a cache TTL for the specified HTTP status code. negativeCaching
