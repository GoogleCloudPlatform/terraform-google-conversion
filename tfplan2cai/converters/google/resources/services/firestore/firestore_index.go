...
func ResourceConverterFirestoreIndex() tpgresource.ResourceConverter {
...
func GetFirestoreIndexCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
