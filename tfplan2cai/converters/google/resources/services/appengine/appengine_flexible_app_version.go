...
func ResourceConverterAppEngineFlexibleAppVersion() tpgresource.ResourceConverter {
...
func GetAppEngineFlexibleAppVersionCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//appengine.googleapis.com/apps/{{project}}/services/{{service}}/versions/{{version_id}}?view=FULL")
	if err != nil {
