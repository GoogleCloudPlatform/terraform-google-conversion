...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20250304231144-31941d5f4741
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.77.0 // indirect
