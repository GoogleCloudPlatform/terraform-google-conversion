...
func ResourceConverterComputeSslCertificate() tpgresource.ResourceConverter {
...
func GetComputeSslCertificateCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
