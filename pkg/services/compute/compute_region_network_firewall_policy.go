...
func init() {
	registry.Schema{
		...
		Schema:      ResourceComputeRegionNetworkFirewallPolicy(),
	}.Register()
}

const ComputeRegionNetworkFirewallPolicySchemaName string = "google_compute_region_network_firewall_policy"
