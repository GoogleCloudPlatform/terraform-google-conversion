...
const DiscoveryEngineDataStoreAssetType string = "discoveryengine.googleapis.com/DataStore"
...
func GetDiscoveryEngineDataStoreCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]cai.Asset, error) {
	name, err := cai.AssetName(d, config, "//discoveryengine.googleapis.com/projects/{{project}}/locations/{{location}}/collections/default_collection/dataStores/{{data_store_id}}")
	if err != nil {
