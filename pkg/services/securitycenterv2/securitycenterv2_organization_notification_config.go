...
func init() {
	registry.Schema{
		Name:        "google_scc_v2_organization_notification_config",
		ProductName: "securitycenterv2",
		Type:        registry.SchemaTypeResource,
		Schema:      ResourceSecurityCenterV2OrganizationNotificationConfig(),
	}.Register()
}

const SecurityCenterV2NotificationConfigAssetType string = "securitycenter.googleapis.com/NotificationConfig"

const SecurityCenterV2OrganizationNotificationConfigSchemaName string = "google_scc_v2_organization_notification_config"
