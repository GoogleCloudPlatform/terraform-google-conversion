...
func DataprocBatchTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetDataprocBatchCaiAssets,
	}
}

func GetDataprocBatchCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	name, err := cai.AssetName(d, config, "//dataproc.googleapis.com/projects/{{project}}/locations/{{location}}/batches/{{batch_id}}")
	if err != nil {
		return []caiasset.Asset{}, err
	}
	if obj, err := GetDataprocBatchCaiObject(d, config); err == nil {
