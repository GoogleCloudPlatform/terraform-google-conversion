...
func ResourceConverterApigeeEndpointAttachment() tpgresource.ResourceConverter {
...
func GetApigeeEndpointAttachmentCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigee.googleapis.com/{{org_id}}/endpointAttachments/{{endpoint_attachment_id}}")
	if err != nil {
