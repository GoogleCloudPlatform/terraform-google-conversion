...
func ResourceConverterComputeRegionDisk() tpgresource.ResourceConverter {
...
func GetComputeRegionDiskCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
