...
func ResourceConverterBeyondcorpAppGateway() tpgresource.ResourceConverter {
...
func GetBeyondcorpAppGatewayCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//beyondcorp.googleapis.com/projects/{{project}}/locations/{{region}}/appGateways/{{name}}")
	if err != nil {
