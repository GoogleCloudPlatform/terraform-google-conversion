...
func ResourceConverterBackupDRManagementServer() tpgresource.ResourceConverter {
...
func GetBackupDRManagementServerCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//backupdr.googleapis.com/projects/{{project}}/locations/{{location}}/managementServers/{{name}}")
	if err != nil {
