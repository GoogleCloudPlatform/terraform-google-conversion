...
func init() {
	registry.Schema{
		Name:        "google_eventarc_google_api_source",
		ProductName: "eventarc",
		Type:        registry.SchemaTypeResource,
		Schema:      ResourceEventarcGoogleApiSource(),
	}.Register()
}

const EventarcGoogleApiSourceAssetType string = "eventarc.googleapis.com/GoogleApiSource"

const EventarcGoogleApiSourceSchemaName string = "google_eventarc_google_api_source"
