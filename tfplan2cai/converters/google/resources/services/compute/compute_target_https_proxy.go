...
func ResourceConverterComputeTargetHttpsProxy() tpgresource.ResourceConverter {
...
func GetComputeTargetHttpsProxyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//compute.googleapis.com/projects/{{project}}/global/targetHttpsProxies/{{name}}")
	if err != nil {
