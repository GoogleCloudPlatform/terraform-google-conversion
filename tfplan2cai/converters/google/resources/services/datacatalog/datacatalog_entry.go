...
func ResourceConverterDataCatalogEntry() tpgresource.ResourceConverter {
...
func GetDataCatalogEntryCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
