...
func ResourceConverterAppEngineStandardAppVersion() tpgresource.ResourceConverter {
...
func GetAppEngineStandardAppVersionCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
