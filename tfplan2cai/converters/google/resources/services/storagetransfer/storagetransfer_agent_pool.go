...
func ResourceConverterStorageTransferAgentPool() tpgresource.ResourceConverter {
...
func GetStorageTransferAgentPoolCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//storagetransfer.googleapis.com/projects/{{project}}/agentPools/{{name}}")
	if err != nil {
