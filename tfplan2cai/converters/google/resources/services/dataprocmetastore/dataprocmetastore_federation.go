...
func ResourceConverterDataprocMetastoreFederation() tpgresource.ResourceConverter {
...
func GetDataprocMetastoreFederationCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
