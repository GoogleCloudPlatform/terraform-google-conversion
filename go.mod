...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20230818223011-7d7cc730875c
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.49.0 // indirect
