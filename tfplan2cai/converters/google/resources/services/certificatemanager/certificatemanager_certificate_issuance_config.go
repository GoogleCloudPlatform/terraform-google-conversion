...
func ResourceConverterCertificateManagerCertificateIssuanceConfig() tpgresource.ResourceConverter {
...
func GetCertificateManagerCertificateIssuanceConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//certificatemanager.googleapis.com/projects/{{project}}/locations/{{location}}/certificateIssuanceConfigs/{{name}}")
	if err != nil {
