...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20231113185244-b94bc80ecf04
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.56.0 // indirect
