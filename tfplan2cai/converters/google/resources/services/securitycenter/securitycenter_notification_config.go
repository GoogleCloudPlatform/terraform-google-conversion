...
func ResourceConverterSecurityCenterNotificationConfig() tpgresource.ResourceConverter {
...
func GetSecurityCenterNotificationConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
