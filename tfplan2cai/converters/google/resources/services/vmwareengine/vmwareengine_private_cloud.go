...
func ResourceConverterVmwareenginePrivateCloud() tpgresource.ResourceConverter {
...
func GetVmwareenginePrivateCloudCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//vmwareengine.googleapis.com/projects/{{project}}/locations/{{location}}/privateClouds/{{name}}")
	if err != nil {
