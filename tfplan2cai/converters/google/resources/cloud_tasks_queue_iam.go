...
func GetCloudTasksQueueIamPolicyCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newCloudTasksQueueIamAsset(d, config, expandIamPolicyBindings)
}

func GetCloudTasksQueueIamBindingCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newCloudTasksQueueIamAsset(d, config, expandIamRoleBindings)
}

func GetCloudTasksQueueIamMemberCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
...
func FetchCloudTasksQueueIamPolicy(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (Asset, error) {
