...
func ResourceConverterApigeeInstanceAttachment() tpgresource.ResourceConverter {
...
func GetApigeeInstanceAttachmentCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigee.googleapis.com/{{instance_id}}/attachments/{{name}}")
	if err != nil {
