...
func ResourceConverterWorkflowsWorkflow() tpgresource.ResourceConverter {
...
func GetWorkflowsWorkflowCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//workflows.googleapis.com/projects/{{project}}/locations/{{region}}/workflows/{{name}}")
	if err != nil {
