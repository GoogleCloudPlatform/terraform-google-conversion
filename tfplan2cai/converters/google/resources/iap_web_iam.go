...
func GetIapWebIamPolicyCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newIapWebIamAsset(d, config, expandIamPolicyBindings)
}

func GetIapWebIamBindingCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
	return newIapWebIamAsset(d, config, expandIamRoleBindings)
}

func GetIapWebIamMemberCaiObject(d TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
...
func FetchIapWebIamPolicy(d TerraformResourceData, config *transport_tpg.Config) (Asset, error) {
