...
func ResourceConverterVertexAIMetadataStore() tpgresource.ResourceConverter {
...
func GetVertexAIMetadataStoreCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//{{region}}-aiplatform.googleapis.com/projects/{{project}}/locations/{{region}}/metadataStores/{{name}}")
	if err != nil {
