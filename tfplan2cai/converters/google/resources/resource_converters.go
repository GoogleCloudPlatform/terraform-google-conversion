...
func ResourceConverters() map[string][]ResourceConverter {
	return map[string][]ResourceConverter{
		...
		"google_bigquery_datapolicy_data_policy_iam_policy":       {resourceConverterBigqueryDatapolicyDataPolicyIamPolicy()},
		"google_bigquery_datapolicy_data_policy_iam_binding":      {resourceConverterBigqueryDatapolicyDataPolicyIamBinding()},
		"google_bigquery_datapolicy_data_policy_iam_member":       {resourceConverterBigqueryDatapolicyDataPolicyIamMember()},
		...
		"google_dataplex_asset_iam_policy":                        {resourceConverterDataplexAssetIamPolicy()},
		"google_dataplex_asset_iam_binding":                       {resourceConverterDataplexAssetIamBinding()},
		"google_dataplex_asset_iam_member":                        {resourceConverterDataplexAssetIamMember()},
		"google_dataplex_datascan_iam_policy":                     {resourceConverterDataplexDatascanIamPolicy()},
		"google_dataplex_datascan_iam_binding":                    {resourceConverterDataplexDatascanIamBinding()},
		"google_dataplex_datascan_iam_member":                     {resourceConverterDataplexDatascanIamMember()},
		"google_dataplex_lake_iam_policy":                         {resourceConverterDataplexLakeIamPolicy()},
		"google_dataplex_lake_iam_binding":                        {resourceConverterDataplexLakeIamBinding()},
		"google_dataplex_lake_iam_member":                         {resourceConverterDataplexLakeIamMember()},
		"google_dataplex_zone_iam_policy":                         {resourceConverterDataplexZoneIamPolicy()},
		"google_dataplex_zone_iam_binding":                        {resourceConverterDataplexZoneIamBinding()},
		"google_dataplex_zone_iam_member":                         {resourceConverterDataplexZoneIamMember()},
