...
func ResourceConverterBeyondcorpAppConnection() tpgresource.ResourceConverter {
...
func GetBeyondcorpAppConnectionCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//beyondcorp.googleapis.com/projects/{{project}}/locations/{{region}}/appConnections/{{name}}")
	if err != nil {
