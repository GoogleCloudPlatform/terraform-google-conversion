...
func ResourceConverterCloudIdsEndpoint() tpgresource.ResourceConverter {
...
func GetCloudIdsEndpointCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//ids.googleapis.com/projects/{{project}}/locations/{{location}}/endpoints/{{name}}")
	if err != nil {
