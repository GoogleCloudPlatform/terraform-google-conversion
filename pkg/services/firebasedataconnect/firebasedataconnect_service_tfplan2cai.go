...
func FirebaseDataConnectServiceTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetFirebaseDataConnectServiceCaiAssets,
	}
}

func GetFirebaseDataConnectServiceCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	...
	if obj, err := GetFirebaseDataConnectServiceCaiObject(d, config); err == nil {
...
func GetFirebaseDataConnectServiceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
