...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20240104214532-b7517d5a9ee2
...
require (
	...
	github.com/GoogleCloudPlatform/declarative-resource-client-library v1.59.0 // indirect
