...
func ResourceConverterAccessContextManagerServicePerimeters() tpgresource.ResourceConverter {
...
func GetAccessContextManagerServicePerimetersCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//accesscontextmanager.googleapis.com/{{parent}}/servicePerimeters")
	if err != nil {
