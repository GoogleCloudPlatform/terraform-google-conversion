...
func ResourceConverterApigeeOrganization() tpgresource.ResourceConverter {
...
func GetApigeeOrganizationCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigee.googleapis.com/organizations/{{name}}")
	if err != nil {
