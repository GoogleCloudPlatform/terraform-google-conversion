...
func ResourceConverterIdentityPlatformInboundSamlConfig() tpgresource.ResourceConverter {
...
func GetIdentityPlatformInboundSamlConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//identitytoolkit.googleapis.com/projects/{{project}}/inboundSamlConfigs/{{name}}")
	if err != nil {
