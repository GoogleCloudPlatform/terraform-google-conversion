...
func ResourceConverterDataplexDatascan() tpgresource.ResourceConverter {
...
func GetDataplexDatascanCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
