...
func resourceConverterDataplexDatascan() ResourceConverter {
...
func GetDataplexDatascanCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]Asset, error) {
