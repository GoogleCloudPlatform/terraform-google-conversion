...
func ResourceConverterAlloydbInstance() tpgresource.ResourceConverter {
...
func GetAlloydbInstanceCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//alloydb.googleapis.com/{{cluster}}/instances/{{instance_id}}")
	if err != nil {
