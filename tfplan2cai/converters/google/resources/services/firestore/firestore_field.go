...
func ResourceConverterFirestoreField() tpgresource.ResourceConverter {
...
func GetFirestoreFieldCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
