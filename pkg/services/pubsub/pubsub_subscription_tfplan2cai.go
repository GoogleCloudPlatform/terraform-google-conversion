...
func PubsubSubscriptionTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetPubsubSubscriptionCaiAssets,
	}
}

func GetPubsubSubscriptionCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	name, err := cai.AssetName(d, config, "//pubsub.googleapis.com/projects/{{project}}/subscriptions/{{name}}")
	if err != nil {
		return []caiasset.Asset{}, err
	}
	if obj, err := GetPubsubSubscriptionCaiObject(d, config); err == nil {
...
func GetPubsubSubscriptionCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
