...
func ResourceConverterSecurityCenterMuteConfig() tpgresource.ResourceConverter {
...
func GetSecurityCenterMuteConfigCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
