...
func Cloudfunctions2functionTfplan2caiConverter() cai.Tfplan2caiConverter {
	return cai.Tfplan2caiConverter{
		Convert: GetCloudfunctions2functionCaiAssets,
	}
}

func GetCloudfunctions2functionCaiAssets(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]caiasset.Asset, error) {
	name, err := cai.AssetName(d, config, "//cloudfunctions.googleapis.com/projects/{{project}}/locations/{{location}}/functions/{{name}}")
	if err != nil {
		return []caiasset.Asset{}, err
	}
	if obj, err := GetCloudfunctions2functionCaiObject(d, config); err == nil {
...
func GetCloudfunctions2functionCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (map[string]interface{}, error) {
