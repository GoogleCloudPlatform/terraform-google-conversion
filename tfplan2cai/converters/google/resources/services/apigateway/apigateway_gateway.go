...
func ResourceConverterApiGatewayGateway() tpgresource.ResourceConverter {
...
func GetApiGatewayGatewayCaiObject(d tpgresource.TerraformResourceData, config *transport_tpg.Config) ([]tpgresource.Asset, error) {
	name, err := tpgresource.AssetName(d, config, "//apigateway.googleapis.com/projects/{{project}}/locations/{{region}}/gateways/{{gateway_id}}")
	if err != nil {
